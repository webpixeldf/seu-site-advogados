          ...
          <div className="bg-[#eaecec] rounded-3xl p-10 md:p-14 lg:p-16">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-700 font-lexend leading-relaxed">
                  E o melhor de tudo: ter um site jurídico profissional cabe no orçamento do seu escritório. Nossos planos começam a partir de R$ 590,00, já com hospedagem, e-mail profissional e suporte humanizado inclusos.
                </p>
              </div>
