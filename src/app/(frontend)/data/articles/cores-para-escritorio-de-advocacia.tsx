...
registerArticle('cores-para-escritorio-de-advocacia', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Direito empresarial e societário:</strong> azul-marinho com dourado ou cinza. Transmite solidez institucional e profissionalismo corporativo.</li>
      <li><strong className="text-[#162a2a]">Direito de família:</strong> azul-claro com tons terrosos ou verde-oliva. Comunica acolhimento sem perder a seriedade.</li>
      <li><strong className="text-[#162a2a]">Direito penal:</strong> bordô com preto ou cinza-escuro. Peso, autoridade e presença.</li>
      <li><strong className="text-[#162a2a]">Direito ambiental:</strong> verde-escuro com marrom ou bege. Conexão direta com natureza e sustentabilidade.</li>
      <li><strong className="text-[#162a2a]">Direito digital e startups:</strong> azul-petróleo com branco ou tons de cinza claro. Modernidade e inovação.</li>
      <li><strong className="text-[#162a2a]">Direito trabalhista:</strong> azul-médio com laranja ou terracota como acento. Equilíbrio entre profissionalismo e acessibilidade.</li>
      <li><strong className="text-[#162a2a]">Direito tributário:</strong> azul-escuro com dourado ou verde-escuro. Precisão, confiança e competência técnica.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Escolher por gosto pessoal:</strong> a cor preferida do sócio fundador pode não ser a melhor cor para o escritório. A decisão deve ser baseada em estratégia, não em preferência individual.</li>
      <li><strong className="text-[#162a2a]">Usar cores demais:</strong> paletas com cinco ou mais cores vibrantes geram poluição visual. A sobriedade é aliada da credibilidade jurídica.</li>
      <li><strong className="text-[#162a2a]">Ignorar o contraste:</strong> texto cinza-claro sobre fundo branco pode parecer elegante no conceito, mas é ilegível na prática. Teste sempre a legibilidade, especialmente em dispositivos móveis.</li>
      <li><strong className="text-[#162a2a]">Copiar a paleta de outro escritório:</strong> inspirar-se é diferente de copiar. Se seu principal concorrente usa azul e dourado, talvez essa seja uma boa razão para escolher outra combinação e se diferenciar.</li>
      <li><strong className="text-[#162a2a]">Não testar em diferentes contextos:</strong> uma cor pode parecer ótima na tela do computador e completamente diferente quando impressa. Teste em ambos os meios antes de definir.</li>
    </ul>
