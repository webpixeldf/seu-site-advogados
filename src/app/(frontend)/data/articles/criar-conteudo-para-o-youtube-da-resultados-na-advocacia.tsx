...
registerArticle('criar-conteudo-para-o-youtube-da-resultados-na-advocacia', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Cenários reais de advogados que usam o YouTube</h2>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Conteúdo que gera visualizações consistentes</h3>

    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Respostas a dúvidas frequentes:</strong> vídeos com títulos como "Quanto tempo demora um processo trabalhista?" ou "Como funciona a pensão alimentícia?" capturam buscas diretas e geram visualizações contínuas.</li>
      <li><strong className="text-[#162a2a]">Explicações de procedimentos:</strong> o público quer entender como funcionam processos que os afetam diretamente. Vídeos como "Passo a passo para dar entrada no divórcio" atendem essa necessidade.</li>
      <li><strong className="text-[#162a2a]">Análise de notícias e mudanças na lei:</strong> quando uma nova legislação é aprovada ou um caso ganha repercussão na mídia, há um pico de buscas. Produzir conteúdo rápido sobre esses temas gera visibilidade imediata.</li>
      <li><strong className="text-[#162a2a]">Desmistificação de crenças populares:</strong> títulos como "5 mitos sobre herança que todo mundo acredita" geram curiosidade e engajamento.</li>
    </ul>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Conteúdo que geralmente não funciona</h3>

    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Aulas acadêmicas:</strong> vídeos com linguagem excessivamente técnica afastam o público leigo, que é seu potencial cliente.</li>
      <li><strong className="text-[#162a2a]">Conteúdo genérico demais:</strong> "O que é o Direito Civil?" não resolve o problema de ninguém e não gera contatos.</li>
      <li><strong className="text-[#162a2a]">Vídeos longos demais sem estrutura:</strong> um vídeo de 40 minutos sem roteiro claro tem alta taxa de abandono e é penalizado pelo algoritmo.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Como descobrir o que seu público quer saber</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Frequência de publicação: qual o mínimo viável</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Duração ideal dos vídeos</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Dicas práticas de edição para advogados</h2>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Elementos que melhoram seus vídeos</h3>

    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Cortes de respiro:</strong> remova pausas longas, repetições e erros de fala. Isso mantém o ritmo e reduz a taxa de abandono.</li>
      <li><strong className="text-[#162a2a]">Texto na tela:</strong> quando mencionar prazos, valores ou artigos de lei, exiba o texto na tela. Isso reforça a informação e facilita a compreensão.</li>
      <li><strong className="text-[#162a2a]">Divisão em capítulos:</strong> use timestamps na descrição do vídeo para que o espectador possa navegar até a parte que mais interessa. O YouTube exibe esses capítulos visualmente na barra de progresso.</li>
      <li><strong className="text-[#162a2a]">Thumbnails consistentes:</strong> crie um padrão visual para as capas dos seus vídeos. Thumbnails com seu rosto, texto legível e cores contrastantes tendem a ter mais cliques.</li>
    </ul>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Ferramentas acessíveis para edição</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Métricas que indicam se o conteúdo está funcionando</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Taxa de cliques (CTR):</strong> mede quantas pessoas clicam no seu vídeo quando ele aparece nos resultados. Uma CTR acima de 5% indica que seus títulos e thumbnails estão atraentes.</li>
      <li><strong className="text-[#162a2a]">Retenção de audiência:</strong> mostra em que ponto as pessoas param de assistir. Se a maioria abandona nos primeiros 30 segundos, sua introdução precisa ser ajustada.</li>
      <li><strong className="text-[#162a2a]">Origens de tráfego:</strong> vídeos encontrados via busca do YouTube ou do Google indicam que sua otimização de palavras-chave está funcionando.</li>
      <li><strong className="text-[#162a2a]">Contatos recebidos:</strong> no fim do dia, a métrica mais importante para um advogado é quantas consultas ou contatos aquele canal está gerando. Pergunte a cada novo cliente como ele chegou até você.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">O tempo até os primeiros resultados</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Conclusão: funciona, mas exige método</h2>
