...
registerArticle('whatsapp-para-advogados', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Mensagem automática de saudação:</strong> configure no WhatsApp Business para responder imediatamente com informações sobre prazo de retorno</li>
      <li><strong className="text-[#162a2a]">Escala de atendimento:</strong> em escritórios com mais de um profissional, defina quem monitora o WhatsApp em cada período</li>
      <li><strong className="text-[#162a2a]">Horários fixos de checagem:</strong> se atua sozinho, defina três momentos por dia para verificar e responder mensagens — manhã, início da tarde e fim da tarde</li>
      <li><strong className="text-[#162a2a]">Notificações organizadas:</strong> separe o WhatsApp profissional do pessoal para evitar que mensagens de clientes se percam</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Consentimento para comunicação:</strong> antes de enviar mensagens proativas (como atualizações de processo), obtenha consentimento do cliente para uso desse canal</li>
      <li><strong className="text-[#162a2a]">Minimização de dados:</strong> solicite apenas os documentos e informações estritamente necessários para o caso</li>
      <li><strong className="text-[#162a2a]">Armazenamento seguro:</strong> ative backup criptografado e evite salvar documentos de clientes na galeria do celular pessoal</li>
      <li><strong className="text-[#162a2a]">Compartilhamento com terceiros:</strong> nunca encaminhe mensagens de um cliente para outro ou para terceiros sem autorização expressa</li>
      <li><strong className="text-[#162a2a]">Descarte adequado:</strong> ao encerrar um caso, defina uma política de retenção — quanto tempo as conversas serão mantidas e quando serão deletadas</li>
    </ul>
    <p className="text-gray-700 leading-relaxed">
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Consentimento prévio:</strong> só inclua na lista pessoas que autorizaram o recebimento de comunicações</li>
      <li><strong className="text-[#162a2a]">Conteúdo informativo:</strong> envie apenas conteúdo educativo ou atualizações relevantes, nunca ofertas de serviço</li>
      <li><strong className="text-[#162a2a]">Frequência moderada:</strong> uma ou duas mensagens por mês é suficiente. Mais do que isso se torna invasivo</li>
      <li><strong className="text-[#162a2a]">Opção de sair:</strong> inclua sempre uma frase como "Se não deseja mais receber nossos informativos, basta responder SAIR"</li>
      <li><strong className="text-[#162a2a]">Segmentação:</strong> crie listas separadas por área — clientes de direito trabalhista não precisam receber informativos sobre direito de família</li>
    </ul>
    <p className="text-gray-700 leading-relaxed">
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Não emita pareceres jurídicos complexos por mensagem — o risco de interpretação equivocada é alto</li>
      <li>Não conduza negociações inteiras por WhatsApp sem formalizar por contrato</li>
      <li>Evite discutir valores de honorários por mensagem antes de uma consulta formal</li>
      <li>Não envie informações sigilosas em grupos — apenas em conversas individuais</li>
      <li>Oriente o cliente a não compartilhar informações sensíveis por áudio em locais públicos</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Use linguagem acessível, mas mantenha a formalidade mínima — evite gírias e abreviações excessivas</li>
      <li>Prefira mensagens escritas a áudios longos, especialmente para informações importantes que o cliente precisará consultar depois</li>
      <li>Confirme o recebimento de documentos enviados pelo cliente</li>
      <li>Ao enviar documentos, nomeie os arquivos de forma clara (ex: "Petição_Inicial_Processo_1234.pdf")</li>
      <li>Mantenha um tom empático sem ser informal demais — o cliente está passando por um momento difícil na maioria dos casos</li>
    </ul>
