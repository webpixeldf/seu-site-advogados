...
registerHtmlArticle('7-erros-comuns-no-instagram-de-advogado-e-como-evitar-cada-um', `<p><img src="/images/blog/7-erros-comuns-no-instagram-de-advogado-e-como-evitar-cada-um.webp" alt="7 erros comuns no Instagram de advogado e como evitar cada um" loading="lazy" /></p>
...
<h2>2. Usar juridiquês como se todo mundo fosse da área</h2>

<p>"Embargos de declaração opostos tempestivamente foram rejeitados por ausência de omissão." Pronto, você perdeu 99% do seu público na primeira linha. O Instagram não é o Diário da Justiça. As pessoas estão rolando o feed enquanto esperam o ônibus ou tomando café da manhã. Se elas precisarem parar e pensar no que você disse, já era.</p>

<p>Traduza tudo. Fale de "recurso", não de "recurso especial". Fale de "prazo", não de "tempestividade". E, acima de tudo, use exemplos práticos: "Sabe quando o patrão não paga as horas extras? Pois é, tem um jeito certo de cobrar isso na Justiça." Quando a pessoa se enxerga no seu conteúdo, ela te procura.</p>
...
<h2>4. Ignorar os stories como se fossem opcionais</h2>

<p>O feed é a fachada do seu escritório. Os stories são a sala de espera. Se você só posta no feed e esquece os stories, você está perdendo o principal canal de conexão com o público. É nos stories que as pessoas tiram dúvidas rápidas, respondem enquetes, assistem você falando de improviso. Isso gera confiança muito mais rápido do que um post caprichado.</p>

<p>Use stories diariamente. Não precisa ser nada complexo: um print de uma decisão interessante comentada por você, uma enquete ("Você sabe o que é dano moral?"), um vídeo de 30 segundos respondendo uma dúvida que recebeu no direct. A regularidade importa mais que a perfeição. E, de quebra, os stories alimentam o algoritmo pra te entregar melhor no feed.</p>
...
<h2>6. Focar só em seguidor e esquecer de conversão</h2>

<p>Seguidor não paga boleto. Cliente, sim. É muito comum ver advogados obcecados com número de seguidores, comprando pacotes de engajamento, fazendo sorteios, tudo pra inflar o número. Só que seguidor comprado ou engajamento artificial não vira cliente. Pior: pode manchar sua credibilidade.</p>

<p>O que gera cliente é conteúdo que leva a ação. Coloque um CTA claro no final de cada post: "Me manda uma mensagem no direct se você passa por isso", "Salva esse post pra consultar depois", "Compartilha com alguém que está nessa situação". E, principalmente, responda todo mundo que te procurar. Nada de deixar a pessoa no vácuo. Cada DM respondida é uma pré-venda.</p>

<p>Outra dica: use o link da bio não só pro site, mas também pra um formulário de contato direto ou agendamento de consulta. Quanto menos cliques a pessoa precisar dar pra falar com você, maior a chance dela fechar.</p>

<h2>7. Não ter consistência e desistir no primeiro mês</h2>
