...
registerArticle('captacao-de-clientes-na-advocacia', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">O que a OAB permite e o que proíbe</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Divulgar valores de honorários em publicidade.</li>
      <li>Fazer promessas de resultados.</li>
      <li>Captar clientes diretamente em locais como delegacias, hospitais ou velórios (a chamada captação de clientela).</li>
      <li>Usar linguagem mercantilista, como "promoção", "desconto" ou "consulta grátis".</li>
      <li>Publicar fotos em tribunais ou audiências com fins publicitários.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Pesquisa de palavras-chave:</strong> identificar os termos que o público-alvo pesquisa e criar conteúdo para cada um deles.</li>
      <li><strong className="text-[#162a2a]">Conteúdo de qualidade:</strong> artigos completos, bem estruturados e que realmente respondam à dúvida do leitor.</li>
      <li><strong className="text-[#162a2a]">SEO técnico:</strong> site rápido, responsivo, com certificado SSL e boa estrutura de URLs.</li>
      <li><strong className="text-[#162a2a]">Google Meu Negócio:</strong> perfil completo com endereço, horário de funcionamento, fotos e avaliações de clientes.</li>
      <li><strong className="text-[#162a2a]">Link building:</strong> menções e links de outros sites relevantes apontando para o seu.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Manter o cliente informado</strong> sobre o andamento do caso de forma proativa, sem esperar que ele pergunte.</li>
      <li><strong className="text-[#162a2a]">Explicar cada etapa</strong> do processo em linguagem simples, ajudando o cliente a entender o que está acontecendo.</li>
      <li><strong className="text-[#162a2a]">Ser acessível:</strong> responder mensagens em prazo razoável e estar disponível nos momentos críticos.</li>
      <li><strong className="text-[#162a2a]">Pedir feedback</strong> ao final do caso e, se positivo, solicitar uma avaliação no Google Meu Negócio.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Origem dos contatos:</strong> de onde vêm os potenciais clientes (Google, redes sociais, indicação, evento).</li>
      <li><strong className="text-[#162a2a]">Taxa de conversão:</strong> quantos contatos se transformam em contratos assinados.</li>
      <li><strong className="text-[#162a2a]">Custo de aquisição:</strong> quanto custa em tempo e dinheiro conquistar cada novo cliente.</li>
      <li><strong className="text-[#162a2a]">Valor médio do caso:</strong> a receita média gerada por cliente ao longo do relacionamento.</li>
    </ul>
