...
registerArticle('advogado-pode-usar-o-tik-tok', () => (
  <>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Permitido: conteúdo educativo e informativo</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Tipos de conteúdo que funcionam no TikTok jurídico</h2>

    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Dicas rápidas de direito:</strong> vídeos de 30 a 60 segundos explicando um direito específico. "Você sabia que tem direito a receber em dobro uma cobrança indevida?" Formato direto, informação clara, linguagem simples.</li>
      <li><strong className="text-[#162a2a]">Mitos e verdades:</strong> desmentir crenças populares sobre o direito. "Mito: quem bate atrás sempre tem culpa. Verdade: depende das circunstâncias." Formato que gera engajamento porque desafia o que as pessoas acham que sabem.</li>
      <li><strong className="text-[#162a2a]">Explicação de situações cotidianas:</strong> "Comprou online e o produto não chegou? Seus direitos são esses..." Conteúdo baseado em situações que o público vive no dia a dia.</li>
      <li><strong className="text-[#162a2a]">Comentários sobre notícias:</strong> quando uma decisão judicial ou uma nova lei ganha destaque na mídia, explique de forma clara e rápida o que ela significa na prática.</li>
      <li><strong className="text-[#162a2a]">Respostas a perguntas dos seguidores:</strong> o TikTok permite gravar vídeos respondendo comentários. Esse formato gera ciclos de engajamento e cria senso de comunidade.</li>
      <li><strong className="text-[#162a2a]">Bastidores da rotina:</strong> como é um dia de audiência, como o advogado se prepara para um julgamento, como funciona a rotina de um escritório. Humaniza a profissão sem revelar informações sigilosas.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Dicas práticas para começar</h2>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Equipamento mínimo</h3>
