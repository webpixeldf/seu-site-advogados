...
registerArticle('bio-para-instagram-de-advocacia', () => (
  <>
    <p className="text-gray-700 leading-relaxed">
      A bio do Instagram é o cartão de visitas digital do advogado. São 150 caracteres que decidem se o visitante vai seguir seu perfil, clicar no link ou simplesmente sair. Uma bio mal feita desperdiça todo o esforço de conteúdo que trouxe a pessoa até ali. Uma bio bem estruturada comunica autoridade, especialidade e acessibilidade em segundos. Este guia apresenta a estrutura ideal, exemplos por área de atuação e os erros mais comuns que advogados cometem.
    </p>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      A estrutura que funciona: quatro linhas essenciais
    </h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      O número da OAB na bio: obrigatório ou opcional?
    </h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      CTA: o que colocar como chamada para ação
    </h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      O link da bio: onde direcionar
    </h2>
    <p className="text-gray-700 leading-relaxed">
      O Instagram permite apenas um link clicável na bio. As opções mais comuns para advogados:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
    ...
    <p className="text-gray-700 leading-relaxed">
      Emojis na bio de advogados geram debate. A resposta prática: depende do posicionamento do escritório e do público-alvo. Um advogado criminalista que atende empresários pode preferir uma bio sóbria, sem emojis. Já uma advogada de direito de família que atende um público mais amplo pode usar emojis como separadores visuais sem perder profissionalismo.
    </p>
    <p className="text-gray-700 leading-relaxed">
      Se optar por emojis, siga estas diretrizes:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      Exemplos de bio por área de atuação
    </h2>
    ...
    <p className="text-gray-700 leading-relaxed">
      "Dra. Fernanda Costa | OAB/MG 98.765<br />
      Advogada Trabalhista<br />
      Seus direitos na demissão, rescisão e FGTS<br />
      📍 Belo Horizonte | Agende sua consulta ↓"
    </p>
    ...
    <p className="text-gray-700 leading-relaxed">
      "Dr. Lucas Andrade | OAB/RJ 45.678<br />
      Divórcio, Guarda e Pensão Alimentícia<br />
      Atendimento humanizado e sigiloso<br />
      Rio de Janeiro | Fale conosco ↓"
    </p>
    ...
    <p className="text-gray-700 leading-relaxed">
      "Oliveira &amp; Santos Advocacia | OAB/SP 12.345<br />
      ⚖️ Direito do Consumidor<br />
      Nome negativado, cobranças indevidas, contratos<br />
      São Paulo | Tire suas dúvidas ↓"
    </p>
    ...
    <p className="text-gray-700 leading-relaxed">
      "Dra. Maria Helena | OAB/PR 67.890<br />
      Especialista em Aposentadoria e Benefícios do INSS<br />
      +500 clientes atendidos em Curitiba e região<br />
    ...
    <p className="text-gray-700 leading-relaxed">
      "Costa Advocacia Imobiliária | OAB/SC 34.567<br />
      Contratos, Distrato e Atraso de Obra<br />
      Protegendo seu investimento imobiliário<br />
      📍 Florianópolis | Agende uma análise ↓"
    </p>
    ...
    <p className="text-gray-700 leading-relaxed">
      "Dr. Ricardo Almeida | OAB/BA 78.901<br />
      Advogado Criminalista<br />
      Defesa técnica em processos criminais<br />
      Salvador | Atendimento 24h para urgências ↓"
    </p>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      O campo "Nome" do perfil: um recurso subutilizado
    </h2>
    <p className="text-gray-700 leading-relaxed">
      O campo "Nome" do Instagram (não o @username) é indexado na busca da plataforma. Isso significa que, quando alguém pesquisa "advogado trabalhista São Paulo" no Instagram, perfis que contêm esses termos no campo Nome têm mais chance de aparecer nos resultados.
    </p>
    <p className="text-gray-700 leading-relaxed">
      Use esse campo estrategicamente. Em vez de colocar apenas "Dr. João Silva", considere "Dr. João Silva | Advogado Trabalhista SP". Isso mantém seu nome visível e adiciona palavras-chave que facilitam ser encontrado por quem está buscando ativamente um profissional.
    </p>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      Erros frequentes em bios de advogados
    </h2>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      ...
      <li><strong className="text-[#162a2a]">Usar o @ pessoal como conta profissional:</strong> @joao_silva_2003 não transmite profissionalismo. Crie um username limpo como @joaosilvaadvocacia ou @silvaadvogados</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      Destaques: a extensão da bio
    </h2>
    <p className="text-gray-700 leading-relaxed">
      Os Destaques do Instagram (Stories fixos abaixo da bio) funcionam como uma extensão da apresentação profissional. Organize-os de forma estratégica:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">"Sobre":</strong> apresentação do advogado e do escritório, formação e experiência</li>
      <li><strong className="text-[#162a2a]">"Áreas":</strong> detalhamento das áreas de atuação</li>
      <li><strong className="text-[#162a2a]">"Dúvidas":</strong> respostas às perguntas mais frequentes dos clientes</li>
      <li><strong className="text-[#162a2a]">"Localização":</strong> fotos do escritório, mapa e instruções de como chegar</li>
      <li><strong className="text-[#162a2a]">"Contato":</strong> formas de agendamento e horários de atendimento</li>
    </ul>
    <p className="text-gray-700 leading-relaxed">
      Use capas uniformes para os Destaques, com ícones e cores consistentes com a identidade visual do escritório. Isso transmite organização e profissionalismo antes mesmo do visitante ler qualquer post.
    </p>
