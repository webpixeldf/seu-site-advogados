...
registerArticle('logomarca-para-advogados', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Azul-marinho:</strong> confiança, estabilidade e profissionalismo. É a cor mais usada em logomarcas jurídicas no mundo inteiro, e por bom motivo.</li>
      <li><strong className="text-[#162a2a]">Dourado ou bronze:</strong> sofisticação, excelência e tradição. Funciona como cor de apoio, em detalhes e acentos.</li>
      <li><strong className="text-[#162a2a]">Verde-escuro:</strong> equilíbrio, crescimento e seriedade. Comum em escritórios de direito ambiental e agrário.</li>
      <li><strong className="text-[#162a2a]">Bordô ou vinho:</strong> autoridade, poder e elegância. Transmite peso e presença.</li>
      <li><strong className="text-[#162a2a]">Preto:</strong> formalidade, luxo e simplicidade. Logomarcas em preto puro são elegantes e versáteis.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Excesso de elementos:</strong> logomarcas com símbolo, nome completo, slogan e moldura ao mesmo tempo ficam poluídas e confusas. Menos é mais.</li>
      <li><strong className="text-[#162a2a]">Fontes incompatíveis:</strong> misturar duas ou mais fontes sem critério compromete a harmonia visual. Se usar duas fontes, certifique-se de que elas se complementam.</li>
      <li><strong className="text-[#162a2a]">Cores vibrantes demais:</strong> vermelho vivo, laranja, amarelo neon e similares podem funcionar em outros setores, mas na advocacia costumam gerar estranhamento.</li>
      <li><strong className="text-[#162a2a]">Baixa resolução:</strong> uma logomarca que fica pixelada quando ampliada é sinal de amadorismo. Sempre trabalhe com arquivos vetoriais (SVG, AI ou EPS).</li>
      <li><strong className="text-[#162a2a]">Seguir modas passageiras:</strong> tendências de design mudam rápido. Uma logomarca precisa durar anos. Evite efeitos visuais que pareçam datados em pouco tempo, como gradientes exagerados ou sombras 3D.</li>
      <li><strong className="text-[#162a2a]">Copiar concorrentes:</strong> inspirar-se é válido, copiar não. Além do problema ético, uma logomarca parecida com a de outro escritório gera confusão no mercado e enfraquece sua marca.</li>
    </ul>
