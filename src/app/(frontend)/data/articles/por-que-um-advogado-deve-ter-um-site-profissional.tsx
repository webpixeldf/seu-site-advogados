...
registerArticle('por-que-um-advogado-deve-ter-um-site-profissional', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Como o cliente de hoje busca um advogado</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Indicações versus tráfego orgânico: por que diversificar</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">O site como ferramenta de filtragem de clientes</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Design moderno e limpo:</strong> visual que transmita seriedade sem ser pesado. Cores sóbrias, tipografia legível, espaçamento adequado.</li>
      <li><strong className="text-[#162a2a]">Responsividade:</strong> o site deve funcionar perfeitamente em celulares, tablets e computadores. Mais de 70% dos acessos a sites jurídicos vêm de dispositivos móveis.</li>
      <li><strong className="text-[#162a2a]">Velocidade de carregamento:</strong> sites lentos perdem visitantes. O tempo ideal de carregamento é abaixo de 3 segundos.</li>
      <li><strong className="text-[#162a2a]">Conteúdo relevante:</strong> textos que falem sobre os problemas dos clientes, não apenas sobre o currículo do advogado.</li>
      <li><strong className="text-[#162a2a]">Canais de contato visíveis:</strong> telefone, WhatsApp, formulário de contato e endereço devem estar acessíveis em qualquer página do site.</li>
      <li><strong className="text-[#162a2a]">Certificado SSL:</strong> o cadeado de segurança no navegador é essencial. Sem ele, o Google marca o site como "não seguro" e os visitantes perdem a confiança.</li>
      <li><strong className="text-[#162a2a]">Número de registro na OAB:</strong> exibir o número de registro reforça a legitimidade e é uma boa prática de transparência.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Objeções comuns e por que não procedem</h2>
    ...
    <p className="text-gray-700 leading-relaxed">
      <strong className="text-[#162a2a]">"Meus clientes vêm por indicação."</strong> Ótimo. Mas mesmo clientes indicados pesquisam o advogado no Google antes de ligar. Um site profissional reforça a indicação recebida. Além disso, ficar dependente de uma única fonte de clientes é um risco para qualquer negócio.
    </p>

    <p className="text-gray-700 leading-relaxed">
      <strong className="text-[#162a2a]">"É muito caro."</strong> O custo de um site profissional é um investimento, não uma despesa. Comparado com o custo de aluguel de um escritório físico, o investimento em um site é uma fração e o retorno potencial é significativamente maior em termos de alcance.
    </p>

    <p className="text-gray-700 leading-relaxed">
      <strong className="text-[#162a2a]">"Não tenho tempo para cuidar de um site."</strong> Um site bem construído não exige manutenção diária. As páginas fixas são atualizadas ocasionalmente. Se houver um blog, a publicação pode ser semanal ou quinzenal. É possível terceirizar a produção de conteúdo e a manutenção técnica.
    </p>
