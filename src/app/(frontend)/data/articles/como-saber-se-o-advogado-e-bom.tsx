...
registerArticle('como-saber-se-o-advogado-e-bom', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Clareza na comunicação</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Transparência nos honorários</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">O valor total ou a forma de cálculo</strong> (fixo, percentual sobre o resultado, mensal ou por ato).</li>
      <li><strong className="text-[#162a2a]">O que está incluído</strong> no valor (quantas audiências, peças processuais, recursos).</li>
      <li><strong className="text-[#162a2a]">Custos adicionais</strong> que podem surgir (custas processuais, honorários periciais, despesas com cartório).</li>
      <li><strong className="text-[#162a2a]">Forma e prazo de pagamento.</strong></li>
      <li><strong className="text-[#162a2a]">Regras sobre rescisão</strong> do contrato por qualquer das partes.</li>
    </ul>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Reputação e avaliações</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Organização e cumprimento de prazos</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Garantia de resultado:</strong> nenhum advogado sério garante que vai ganhar o caso.</li>
      <li><strong className="text-[#162a2a]">Pressão para contratar imediatamente:</strong> frases como "se não contratar agora, perde o prazo" sem apresentar fundamentação são táticas de pressão inaceitáveis.</li>
      <li><strong className="text-[#162a2a]">Pedido de valores em conta pessoal:</strong> pagamentos devem ser feitos ao escritório ou à sociedade, nunca na conta pessoal do advogado sem justificativa formal.</li>
      <li><strong className="text-[#162a2a]">Falta de contrato:</strong> trabalhar sem contrato de honorários escrito é irregular e coloca o cliente em situação vulnerável.</li>
      <li><strong className="text-[#162a2a]">Inacessibilidade:</strong> se o advogado já é difícil de contatar antes da contratação, imagine durante o processo.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">A consulta inicial como teste</h2>
