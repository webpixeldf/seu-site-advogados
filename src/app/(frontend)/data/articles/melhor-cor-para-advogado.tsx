...
registerArticle('melhor-cor-para-advogado', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      ...
      <li><strong className="text-[#162a2a]">Cores neon:</strong> transmitem modernidade extrema e informalidade. Não são compatíveis com a percepção de solidez que a maioria dos clientes jurídicos espera.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Fundo:</strong> branco ou tons muito claros de cinza. Fundos escuros podem funcionar em seções específicas (como o rodapé ou a seção de destaque), mas o corpo principal do site deve ter fundo claro para garantir legibilidade.</li>
      <li><strong className="text-[#162a2a]">Texto principal:</strong> cinza-escuro ou preto suave. Nunca preto puro (#000000), que gera contraste excessivo e cansa a leitura. Tons como #333333 ou #2d2d2d são mais confortáveis.</li>
      <li><strong className="text-[#162a2a]">Títulos:</strong> na cor principal da marca (azul-marinho, verde-escuro, bordô). Isso reforça a identidade visual em cada seção da página.</li>
      <li><strong className="text-[#162a2a]">Botões de ação:</strong> na cor principal ou em uma cor de destaque que contraste com o fundo. O botão "Fale Conosco" precisa ser visível sem ser agressivo.</li>
      <li><strong className="text-[#162a2a]">Detalhes:</strong> linhas, ícones e bordas na cor secundária (dourado, cinza-médio). Esses elementos criam ritmo visual e refinamento.</li>
    </ul>
