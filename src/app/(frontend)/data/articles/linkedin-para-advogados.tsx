...
registerArticle('linkedin-para-advogados', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Advogado Tributarista | Reduzo a carga tributária de empresas do Simples ao Lucro Real</li>
      <li>Advogada Trabalhista Empresarial | Prevenção de passivos e defesa em reclamações</li>
      <li>Advogado Empresarial | Contratos, M&amp;A e Proteção Patrimonial para PMEs</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Publique em horários estratégicos.</strong> Terça a quinta, entre 7h e 9h ou entre 17h e 19h, são os horários de maior atividade no Brasil.</li>
      <li><strong className="text-[#162a2a]">Comece com um gancho forte.</strong> As duas primeiras linhas do post determinam se a pessoa vai clicar em &quot;ver mais&quot;. Abra com um dado impactante, uma pergunta ou uma afirmação provocativa.</li>
      <li><strong className="text-[#162a2a]">Termine com uma pergunta.</strong> Convide o leitor a compartilhar a experiência dele. Perguntas nos comentários aumentam o alcance do post.</li>
      <li><strong className="text-[#162a2a]">Responda todos os comentários.</strong> Cada resposta sua conta como uma nova interação e reaquece a distribuição do post.</li>
      <li><strong className="text-[#162a2a]">Comente em publicações de outras pessoas.</strong> Engajamento gera reciprocidade. Quando você comenta algo relevante no post de um empresário, ele provavelmente vai ver seu perfil e suas publicações.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Usar linguagem excessivamente jurídica.</strong> Se o seu público-alvo são empresários, escreva para empresários. Termos como &quot;animus contrahendi&quot; ou &quot;pacta sunt servanda&quot; afastam quem não é da área.</li>
      <li><strong className="text-[#162a2a]">Publicar apenas autopromoção.</strong> Posts como &quot;participei do evento X&quot; ou &quot;nosso escritório completou 10 anos&quot; não geram engajamento porque não entregam valor ao leitor.</li>
      <li><strong className="text-[#162a2a]">Ignorar o visual do post.</strong> Textos sem espaçamento, sem parágrafos curtos e sem emojis estratégicos (usados com moderação) têm taxa de leitura muito baixa.</li>
      <li><strong className="text-[#162a2a]">Não interagir com a rede.</strong> O LinkedIn é uma via de mão dupla. Se você só publica e nunca comenta ou responde, perde metade do potencial da plataforma.</li>
      <li><strong className="text-[#162a2a]">Copiar conteúdo de outros advogados.</strong> O público percebe quando um post é genérico. Quanto mais pessoal e específico for o conteúdo, maior o impacto.</li>
    </ul>
