...
registerArticle('trafego-pago-para-advogados', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      ...
      <li>Formatos de anúncio menos dependentes de criativo visual</li>
    </ul>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Qual plataforma escolher por área de atuação</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Como distribuir o orçamento</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Expectativas realistas de ROI</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Mês 1:</strong> Fase de aprendizado. O algoritmo está coletando dados. Espere custos por lead mais altos e leads de qualidade variável</li>
      <li><strong className="text-[#162a2a]">Mês 2:</strong> Primeiras otimizações com base em dados reais. Custo por lead começa a cair</li>
      <li><strong className="text-[#162a2a]">Mês 3:</strong> Campanhas começam a estabilizar. Você já sabe quais palavras-chave e públicos funcionam</li>
      <li><strong className="text-[#162a2a]">Meses 4-6:</strong> Escala. Aumento gradual do investimento nas campanhas que comprovaram resultado</li>
    </ul>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">O que a OAB permite em anúncios pagos</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Os anúncios devem ter caráter informativo e não podem ser mercantilistas</li>
      <li>É proibido fazer captação direta de clientes com linguagem agressiva de vendas</li>
      <li>Não se pode prometer resultados ou garantir êxito em causas</li>
      <li>É vedado divulgar valores de honorários nos anúncios</li>
      <li>Não é permitido usar depoimentos de clientes como forma de propaganda</li>
      <li>O anúncio deve conter o nome do advogado ou do escritório e o número da OAB</li>
    </ul>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Integrando Google e Meta em uma estratégia completa</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>O Google Ads captura quem já está buscando ativamente um advogado</li>
      <li>O Meta Ads impacta quem ainda não sabe que precisa de assessoria jurídica</li>
      <li>O remarketing no Meta exibe anúncios para quem visitou seu site via Google mas não converteu</li>
