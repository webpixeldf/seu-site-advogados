...
registerArticle('como-atrair-clientes-de-advocacia-pelo-instagram', () => (
  <>
    ...
    <p className="text-gray-700 leading-relaxed">
      Categorias de conteúdo que comprovadamente atraem potenciais clientes:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Posts de dúvidas frequentes:</strong> "Posso ser demitido durante atestado médico?", "Quanto tempo demora um processo de divórcio?"</li>
      <li><strong className="text-[#162a2a]">Posts de direitos que as pessoas não conhecem:</strong> "3 direitos do consumidor que o mercado não quer que você saiba"</li>
      <li><strong className="text-[#162a2a]">Comentários sobre notícias:</strong> quando uma decisão judicial relevante sai na mídia, explique o impacto prático na vida das pessoas</li>
      <li><strong className="text-[#162a2a]">Passo a passo:</strong> "Como pedir pensão alimentícia: o guia completo em 7 passos"</li>
      <li><strong className="text-[#162a2a]">Mitos e verdades:</strong> "É verdade que processo trabalhista demora 5 anos? Depende."</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      Hashtags: como usar para alcançar pessoas certas
    </h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      Segmentação local: como ser encontrado na sua cidade
    </h2>
    <p className="text-gray-700 leading-relaxed">
      Advocacia é, na maioria dos casos, um serviço local. Mesmo com a possibilidade de atendimento online, a maioria dos clientes prefere um advogado na mesma cidade. O Instagram oferece recursos para reforçar sua presença local:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      DMs: o momento da conversão
    </h2>
    <p className="text-gray-700 leading-relaxed">
      As mensagens diretas (DMs) são onde o seguidor se transforma em cliente potencial. Quando alguém envia uma mensagem perguntando sobre um caso, esse é o momento mais crítico de toda a estratégia. A forma como você responde define se a pessoa agenda uma consulta ou procura outro profissional.
    </p>
    <p className="text-gray-700 leading-relaxed">
      Regras para atendimento eficiente nas DMs:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Responda rápido:</strong> o ideal é em menos de uma hora durante o horário comercial. Mensagens respondidas no dia seguinte raramente convertem</li>
      <li><strong className="text-[#162a2a]">Não dê consultoria gratuita:</strong> ouça o relato brevemente, demonstre empatia e direcione para uma consulta formal. "Entendo sua situação. Esse é um caso que exige uma análise mais detalhada. Posso agendar uma consulta para avaliarmos juntos?"</li>
      <li><strong className="text-[#162a2a]">Migre para o WhatsApp:</strong> a DM do Instagram não é o melhor canal para conversas longas. Após o contato inicial, sugira continuar pelo WhatsApp para um atendimento mais completo</li>
      <li><strong className="text-[#162a2a]">Use respostas rápidas:</strong> o Instagram permite salvar respostas prontas para mensagens recorrentes, economizando tempo</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      O funil de conversão do Instagram para advocacia
    </h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      Métricas que indicam se a estratégia funciona
    </h2>
    <p className="text-gray-700 leading-relaxed">
      Curtidas e número de seguidores são métricas de vaidade. As métricas que realmente indicam se o Instagram está gerando clientes são:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Colaborações (Collabs):</strong> publique posts em conjunto com profissionais complementares. Um post colaborativo com um contador sobre "O que muda no IR para quem recebeu indenização trabalhista" aparece nos dois perfis e atinge ambas as audiências</li>
      <li><strong className="text-[#162a2a]">Lives temáticas:</strong> faça transmissões ao vivo respondendo dúvidas sobre um tema específico. Lives geram notificações para seguidores e podem ser salvas como conteúdo permanente</li>
      <li><strong className="text-[#162a2a]">Séries de conteúdo:</strong> crie uma série semanal com nome próprio, como "Minuto Trabalhista" ou "Direito na Prática". Séries criam expectativa e hábito de consumo</li>
      <li><strong className="text-[#162a2a]">Impulsionamento de posts campeões:</strong> identifique os posts com melhor desempenho orgânico e invista R$ 15 a R$ 30 para ampliar o alcance. É o investimento mais eficiente em publicidade no Instagram</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">
      O que evitar na estratégia de atração
    </h2>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Comprar seguidores:</strong> além de não gerar clientes, perfis com seguidores falsos têm engajamento baixíssimo, o que prejudica o alcance orgânico</li>
      <li><strong className="text-[#162a2a]">Usar bots de interação:</strong> comentários automáticos e curtidas em massa violam os termos do Instagram e podem resultar em bloqueio da conta</li>
      <li><strong className="text-[#162a2a]">Publicar apenas sobre si mesmo:</strong> posts de conquistas pessoais e certificados são válidos ocasionalmente, mas o perfil precisa ser majoritariamente sobre o público, não sobre você</li>
      <li><strong className="text-[#162a2a]">Abandonar o perfil:</strong> intervalos longos sem publicação resetam o algoritmo. Se precisar parar, deixe posts agendados para manter a presença</li>
    </ul>
