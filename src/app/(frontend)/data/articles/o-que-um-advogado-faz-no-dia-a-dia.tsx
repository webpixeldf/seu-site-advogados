...
registerArticle('o-que-um-advogado-faz-no-dia-a-dia', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">A manhã: prazos, e-mails e processos</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Análise dos fatos:</strong> revisão detalhada dos documentos e relatos do cliente para construir a narrativa do caso.</li>
      <li><strong className="text-[#162a2a]">Pesquisa jurídica:</strong> busca por legislação aplicável, jurisprudência relevante e doutrina que fundamentem os argumentos.</li>
      <li><strong className="text-[#162a2a]">Redação:</strong> construção do texto com clareza, lógica e persuasão, respeitando os requisitos formais de cada tipo de peça.</li>
      <li><strong className="text-[#162a2a]">Revisão:</strong> conferência de dados, referências legais, nomes das partes e cálculos, quando aplicável.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Atendimento ao cliente</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Atividades administrativas</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Variações por área de atuação</h2>
