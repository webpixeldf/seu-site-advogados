...
registerArticle('seo-para-advogados', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      ...
      <li>
        <strong className="text-[#162a2a]">Copiar conteúdo de outros sites:</strong> O Google penaliza conteúdo duplicado. Se você copiou a descrição de uma área de atuação do site de outro escritório (ou de um modelo de site), o Google sabe. E não vai ranquear nenhuma das cópias.
      </li>
      <li>
        <strong className="text-[#162a2a]">Ignorar o celular:</strong> Muitos advogados aprovam o site olhando no computador do escritório e nunca testam no celular. O resultado é um site que fica ilegível em telas menores.
      </li>
      <li>
        <strong className="text-[#162a2a]">Não ter uma página de contato decente:</strong> A página de contato precisa ter endereço completo, telefone clicável, mapa, formulário funcionando e, de preferência, link para WhatsApp. Muitos sites têm apenas um formulário que nem funciona.
      </li>
      <li>
        <strong className="text-[#162a2a]">Achar que SEO é um serviço pontual:</strong> SEO não é algo que você faz uma vez e esquece. O Google atualiza seu algoritmo constantemente, concorrentes publicam conteúdo novo e as palavras-chave mudam. É um trabalho contínuo.
      </li>
      <li>
        <strong className="text-[#162a2a]">Usar jargão jurídico pesado nos textos:</strong> Seus clientes potenciais não são advogados. Se o artigo do blog está cheio de citações de artigos de lei e linguagem de petição, o leitor vai embora. Escreva de forma acessível.
      </li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Concorrência na sua cidade:</strong> Um advogado em uma cidade de 50 mil habitantes compete com menos sites do que um advogado em São Paulo. Quanto menor a concorrência, mais rápido os resultados aparecem.</li>
      <li><strong className="text-[#162a2a]">Nicho de atuação:</strong> &quot;Advogado de direito aeronáutico em Porto Alegre&quot; tem muito menos concorrência do que &quot;advogado trabalhista em São Paulo&quot;. Nichos específicos ranqueiam mais rápido.</li>
      <li><strong className="text-[#162a2a]">Qualidade e frequência do conteúdo:</strong> Sites que publicam conteúdo relevante com regularidade crescem mais rápido do que sites estáticos.</li>
      <li><strong className="text-[#162a2a]">Idade do domínio:</strong> Domínios mais antigos tendem a ter mais autoridade. Um site registrado há 5 anos larga na frente de um registrado semana passada.</li>
    </ul>
