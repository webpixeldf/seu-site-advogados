...
registerArticle('legal-design-e-visual-law', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">O que é visual law</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Aplicações práticas no dia a dia jurídico</h2>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Termos de uso e políticas de privacidade</h3>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Comunicação com o cliente</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Ferramentas para aplicar visual law</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Canva:</strong> permite criar fluxogramas, infográficos e elementos visuais com templates prontos. A versão gratuita já atende a maioria das necessidades.</li>
      <li><strong className="text-[#162a2a]">Microsoft Word e PowerPoint:</strong> os recursos de SmartArt, tabelas e formas do próprio Word permitem criar documentos visuais sem sair do ambiente familiar.</li>
      <li><strong className="text-[#162a2a]">Piktochart:</strong> ferramenta online para criação de infográficos, útil para relatórios e apresentações.</li>
      <li><strong className="text-[#162a2a]">Miro:</strong> quadro branco digital ideal para mapear processos e criar fluxogramas colaborativos.</li>
      <li><strong className="text-[#162a2a]">Flaticon e Noun Project:</strong> bancos de ícones gratuitos que podem ser inseridos em contratos e petições.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Princípios de design aplicados a documentos jurídicos</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Como começar a aplicar no seu escritório</h2>
