...
registerArticle('ferramentas-do-google-para-advogados', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Docs: redação e colaboração em documentos</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Drive: armazenamento e organização de arquivos</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Agenda: controle de prazos e compromissos</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Analytics: entendendo o tráfego do seu site</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Search Console: visibilidade nos resultados de busca</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Meu Negócio: presença local no Google</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Alerts: monitoramento de temas relevantes</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Google Keep: notas rápidas e listas de tarefas</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Anotações de reunião</strong> — registrar pontos discutidos com cliente durante uma reunião rápida</li>
      <li><strong className="text-[#162a2a]">Listas de providências</strong> — criar checklists de documentos necessários para cada processo</li>
      <li><strong className="text-[#162a2a]">Lembretes por localização</strong> — configurar um lembrete que aparece quando você chega ao fórum, por exemplo</li>
      <li><strong className="text-[#162a2a]">Notas com etiquetas</strong> — organizar anotações por cliente, área do direito ou tipo de tarefa</li>
    </ul>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Integrando as ferramentas no dia a dia</h2>
