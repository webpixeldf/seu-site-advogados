...
registerArticle('landing-page-de-alta-conversao-para-advogados', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">O que é uma landing page e por que ela importa na advocacia</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Prova social: depoimentos e números que geram confiança</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Depoimentos de clientes:</strong> textos curtos com nome e, se possível, foto. Depoimentos em vídeo têm ainda mais impacto. Respeite sempre a autorização do cliente e as normas da OAB sobre publicidade.</li>
      <li><strong className="text-[#162a2a]">Números do escritório:</strong> quantidade de clientes atendidos, anos de atuação, processos com resultado favorável. Números concretos são mais convincentes do que adjetivos vagos.</li>
      <li><strong className="text-[#162a2a]">Avaliações do Google:</strong> se seu escritório tem boas avaliações no Google Meu Negócio, exiba a nota e alguns comentários na landing page.</li>
      <li><strong className="text-[#162a2a]">Logos e selos:</strong> registro na OAB, certificações, participação em associações jurídicas relevantes.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Formulário de contato: menos campos, mais conversões</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">CTA: o botão que precisa ser impossível de ignorar</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Trust signals: elementos que reforçam a credibilidade</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Foto profissional do advogado:</strong> rostos humanos geram conexão. Uma foto de qualidade, com traje profissional e fundo neutro, transmite seriedade.</li>
      <li><strong className="text-[#162a2a]">Número da OAB visível:</strong> exibir o registro profissional reforça a legitimidade.</li>
      <li><strong className="text-[#162a2a]">Endereço e telefone reais:</strong> mesmo que o atendimento seja online, mostrar um endereço físico e telefone fixo aumenta a confiança.</li>
      <li><strong className="text-[#162a2a]">Política de privacidade:</strong> informar que os dados do visitante serão tratados com sigilo é especialmente relevante no contexto jurídico.</li>
      <li><strong className="text-[#162a2a]">Certificado SSL:</strong> o cadeado no navegador é básico, mas sua ausência gera desconfiança imediata.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Design mobile-first: a maioria acessa pelo celular</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Teste A/B: decisões baseadas em dados, não em achismo</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Texto focado no advogado, não no cliente:</strong> o visitante quer saber como você resolve o problema dele, não quantos diplomas você tem.</li>
      <li><strong className="text-[#162a2a]">Múltiplos objetivos na mesma página:</strong> se a página tenta vender consulta, captar e-mail e apresentar o escritório ao mesmo tempo, nenhuma dessas ações será feita bem.</li>
      <li><strong className="text-[#162a2a]">Ausência de urgência:</strong> o visitante precisa de um motivo para agir agora. Frases como "vagas limitadas para consulta esta semana" ou "prazos processuais podem estar correndo" criam senso de urgência legítimo.</li>
      <li><strong className="text-[#162a2a]">Página lenta:</strong> landing pages com tempo de carregamento acima de 3 segundos perdem uma parcela significativa dos visitantes antes mesmo de exibirem o conteúdo.</li>
      <li><strong className="text-[#162a2a]">Falta de rastreamento:</strong> sem Google Analytics, pixel do Facebook ou outras ferramentas de rastreamento, é impossível saber o que está funcionando e o que precisa melhorar.</li>
    </ul>
