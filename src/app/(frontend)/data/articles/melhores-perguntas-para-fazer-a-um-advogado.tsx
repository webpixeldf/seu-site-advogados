...
registerArticle('melhores-perguntas-para-fazer-a-um-advogado', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Perguntas sobre experiência e qualificação</h2>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Qual é a sua área de especialização?</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Perguntas sobre o caso específico</h2>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Quanto tempo o processo pode levar?</h3>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Existem alternativas ao processo judicial?</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Perguntas sobre honorários e custos</h2>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Como posso acompanhar o andamento do meu caso?</h3>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Qual é o prazo médio de resposta para mensagens?</h3>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Quem será o advogado responsável pelo meu caso?</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Perguntas sobre documentos necessários</h2>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Que documentos eu preciso reunir?</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Sinais de alerta durante a consulta</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Garante resultados ou promete vitória antes de analisar o caso em profundidade.</li>
      <li>Não quer formalizar honorários por escrito.</li>
      <li>Fala mal de outros advogados ou de colegas de profissão.</li>
      <li>Pressiona para que você assine o contrato imediatamente, sem tempo para pensar.</li>
      <li>Não demonstra interesse em ouvir os detalhes do seu caso.</li>
      <li>Evita perguntas sobre custos ou dá respostas vagas sobre valores.</li>
    </ul>
