...
registerArticle('google-ads-para-advogados', () => (
  <>
    <p className="text-gray-700 leading-relaxed">
      O Google Ads é uma das ferramentas mais eficientes para advogados que desejam atrair clientes de forma previsível. Diferente de estratégias orgânicas que levam meses para dar resultado, uma campanha bem estruturada pode gerar contatos qualificados já nos primeiros dias. O desafio está em configurar tudo corretamente para não desperdiçar orçamento e, ao mesmo tempo, respeitar as regras da OAB sobre publicidade.
    </p>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Por que o Google Ads funciona para advogados</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <p className="text-gray-700 leading-relaxed">
      O primeiro passo é criar uma conta no Google Ads acessando ads.google.com. Durante a configuração inicial, o Google vai tentar direcioná-lo para campanhas automáticas simplificadas. Ignore essa sugestão e opte pelo modo especialista, que dá controle total sobre suas campanhas.
    </p>
    <p className="text-gray-700 leading-relaxed">
      Configure corretamente os seguintes pontos antes de criar qualquer campanha:
    </p>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Pesquisa de palavras-chave: a base de tudo</h2>
    <p className="text-gray-700 leading-relaxed">
      A escolha das palavras-chave determina o sucesso ou fracasso da campanha. Use o Planejador de Palavras-chave do Google para identificar os termos que seus potenciais clientes realmente pesquisam. Existem três categorias principais para advogados:
    </p>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Palavras-chave de alta intenção</h3>
    <p className="text-gray-700 leading-relaxed">
      São termos como "advogado de família em Campinas", "escritório de advocacia criminal" ou "advogado para rescisão trabalhista". Quem pesquisa isso está pronto para contratar. O custo por clique é mais alto, mas a taxa de conversão compensa.
    </p>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Palavras-chave informativas com potencial</h3>
    <p className="text-gray-700 leading-relaxed">
      Termos como "quanto custa um advogado trabalhista" ou "como funciona inventário extrajudicial" indicam que a pessoa está pesquisando antes de contratar. O custo por clique é menor e, com uma boa página de destino, essas buscas também geram clientes.
    </p>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Palavras-chave negativas</h3>
    <p className="text-gray-700 leading-relaxed">
      Tão importantes quanto as palavras-chave que você quer são as que você precisa excluir. Adicione como negativas termos como "grátis", "gratuito", "concurso", "salário", "estágio", "OAB prova" e "modelo de petição". Sem essa filtragem, boa parte do seu orçamento será desperdiçada com cliques de pessoas que não são potenciais clientes.
    </p>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Escrevendo anúncios que geram cliques qualificados</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      ...
      <li>Utilize extensões de anúncio: sitelinks para áreas de atuação, extensão de chamada, extensão de local</li>
    </ul>
    <p className="text-gray-700 leading-relaxed">
      Lembre-se de que o anúncio precisa filtrar o público. Você quer atrair quem realmente precisa dos seus serviços e afastar curiosos. Ser específico na sua mensagem faz esse trabalho.
    </p>
    ...
    <p className="text-gray-700 leading-relaxed">
      O custo por clique para termos jurídicos no Brasil varia bastante dependendo da área e da região. Palavras-chave de direito trabalhista em capitais podem custar entre R$ 5 e R$ 20 por clique. Áreas como direito empresarial ou tributário tendem a ser mais caras.
    </p>
    <p className="text-gray-700 leading-relaxed">
      Para começar, defina um orçamento diário que permita pelo menos 10 a 15 cliques por dia. Se o custo médio por clique na sua área é R$ 10, isso significa cerca de R$ 100 a R$ 150 por dia, ou R$ 3.000 a R$ 4.500 por mês. Esse volume é necessário para que o algoritmo do Google tenha dados suficientes para otimizar a campanha.
    </p>
    <p className="text-gray-700 leading-relaxed">
      Comece com um orçamento menor nas duas primeiras semanas para testar e ajustar. Analise quais palavras-chave geram conversões e quais apenas consomem orçamento. Depois, redirecione o investimento para o que funciona.
    </p>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Índice de qualidade: como pagar menos por clique</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Monitoramento e otimização contínua</h2>
    <p className="text-gray-700 leading-relaxed">
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Erros comuns que desperdiçam orçamento</h2>
    <p className="text-gray-700 leading-relaxed">
      Muitos advogados tentam fazer Google Ads por conta própria e acabam frustrando-se com os resultados. Os erros mais frequentes são:
    </p>
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Usar correspondência ampla sem palavras-chave negativas, atraindo cliques irrelevantes</li>
      <li>Enviar todo o tráfego para a página inicial do site em vez de landing pages específicas</li>
      <li>Não configurar o rastreamento de conversões, impedindo qualquer otimização baseada em dados</li>
      <li>Definir a segmentação geográfica para todo o Brasil quando o atendimento é local</li>
