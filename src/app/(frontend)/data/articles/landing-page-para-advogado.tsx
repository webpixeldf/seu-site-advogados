...
registerArticle('landing-page-para-advogado', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Apresenta o escritório como um todo: história, equipe, áreas de atuação, blog, contato.</li>
      <li>Funciona como base de presença digital permanente.</li>
      <li>É indexado pelo Google e recebe tráfego orgânico ao longo do tempo.</li>
      <li>Tem múltiplas páginas e caminhos de navegação.</li>
      <li>Ideal para quem busca informações gerais sobre o escritório.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Foca em uma única área de atuação ou serviço.</li>
      <li>Tem um único objetivo de conversão (formulário, WhatsApp, agendamento).</li>
      <li>Elimina distrações: sem menu de navegação, sem links para outras páginas.</li>
      <li>É usada como destino de campanhas pagas ou ações específicas.</li>
      <li>Ideal para quem já está buscando uma solução para um problema concreto.</li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>
        <strong className="text-[#162a2a]">Menu de navegação:</strong> se a página tem um menu com links para outras partes do site, o visitante se distrai e sai. A landing page deve ser um beco sem saída: a única opção é converter ou fechar a aba.
      </li>
      <li>
        <strong className="text-[#162a2a]">Texto genérico:</strong> "Oferecemos soluções jurídicas completas para pessoas físicas e jurídicas" não diz nada. O visitante precisa se identificar com o problema descrito na página.
      </li>
      <li>
        <strong className="text-[#162a2a]">Página lenta:</strong> se a página demora mais de três segundos para carregar, mais da metade dos visitantes abandona antes de ver o conteúdo. Isso é especialmente crítico em dispositivos móveis.
      </li>
      <li>
        <strong className="text-[#162a2a]">Falta de informação de contato visível:</strong> telefone, WhatsApp e endereço devem estar facilmente acessíveis. Esconder o contato no rodapé é perder oportunidades.
      </li>
      <li>
        <strong className="text-[#162a2a]">Não testar no celular:</strong> a maioria do tráfego pago vem de dispositivos móveis. Se a página não funciona bem no celular, o investimento em anúncios está sendo jogado fora.
      </li>
    </ul>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>
        <strong className="text-[#162a2a]">Taxa de conversão:</strong> percentual de visitantes que preenchem o formulário ou entram em contato. Uma landing page bem feita para advocacia costuma converter entre 5% e 15% do tráfego.
      </li>
      <li>
