...
registerArticle('advogados-criminalistas-famosos', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Evandro Lins e Silva</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Técio Lins e Silva</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Kakay (José Luis de Oliveira Lima)</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Luiz Flávio Borges D'Urso</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Augusto de Arruda Botelho</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Características comuns dos grandes criminalistas</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Domínio técnico do Direito Penal e Processual Penal:</strong> conhecimento profundo da legislação, jurisprudência e doutrina.</li>
      <li><strong className="text-[#162a2a]">Oratória persuasiva:</strong> a capacidade de comunicar argumentos complexos de forma clara e convincente, especialmente no Tribunal do Júri.</li>
      <li><strong className="text-[#162a2a]">Coragem institucional:</strong> disposição para enfrentar o poder do Estado e a pressão da opinião pública em defesa dos direitos do acusado.</li>
      <li><strong className="text-[#162a2a]">Resiliência emocional:</strong> lidar com a pressão de casos graves e com a carga emocional que envolve crimes violentos exige equilíbrio psicológico excepcional.</li>
      <li><strong className="text-[#162a2a]">Comprometimento com garantias fundamentais:</strong> a defesa do devido processo legal como valor inegociável, independentemente da natureza do crime ou do perfil do acusado.</li>
    </ul>
