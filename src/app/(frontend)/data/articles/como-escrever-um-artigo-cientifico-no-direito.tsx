...
registerArticle('como-escrever-um-artigo-cientifico-no-direito', () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Estrutura básica de um artigo jurídico</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Título:</strong> claro, específico e conciso. Evite títulos genéricos ou excessivamente longos.</li>
      <li><strong className="text-[#162a2a]">Resumo e palavras-chave:</strong> o resumo tem entre 150 e 250 palavras e apresenta o problema, a metodologia e as conclusões. As palavras-chave (3 a 5) facilitam a indexação.</li>
      <li><strong className="text-[#162a2a]">Introdução:</strong> apresenta o problema de pesquisa, justifica a relevância do tema e descreve a estrutura do artigo.</li>
      <li><strong className="text-[#162a2a]">Desenvolvimento:</strong> dividido em seções e subseções, é onde ocorre a análise propriamente dita. Cada seção deve ter um objetivo claro.</li>
      <li><strong className="text-[#162a2a]">Conclusão:</strong> retoma o problema inicial e apresenta as respostas encontradas. Não deve introduzir argumentos novos.</li>
      <li><strong className="text-[#162a2a]">Referências:</strong> lista completa das obras citadas, formatada conforme as normas da ABNT ou da revista escolhida.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Pesquisa bibliográfica: onde encontrar fontes</h2>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Google Scholar (Google Acadêmico):</strong> o ponto de partida mais prático. Busca artigos, teses e livros acadêmicos. Use aspas para buscas exatas e o operador "site:" para filtrar por repositórios específicos.</li>
      <li><strong className="text-[#162a2a]">Plataforma Sucupira:</strong> lista as revistas científicas avaliadas pela CAPES, com classificação Qualis. Útil para identificar revistas de qualidade para publicação.</li>
      <li><strong className="text-[#162a2a]">SciELO:</strong> biblioteca digital com milhares de artigos em acesso aberto, incluindo periódicos jurídicos brasileiros.</li>
      <li><strong className="text-[#162a2a]">Repositórios de tribunais:</strong> as bases de jurisprudência do STF, STJ e tribunais regionais são fontes primárias essenciais para artigos que analisam decisões judiciais.</li>
      <li><strong className="text-[#162a2a]">Bibliotecas digitais de universidades:</strong> USP, UERJ, UnB e outras universidades disponibilizam teses e dissertações em acesso aberto.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Metodologia: como abordar o tema</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Redação: dicas práticas para escrever melhor</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Onde publicar: escolhendo a revista certa</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">O processo de avaliação por pares</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Erros frequentes em artigos jurídicos</h2>

    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Escolher tema amplo demais e tratar superficialmente.</li>
      <li>Confundir opinião pessoal com argumento fundamentado.</li>
      <li>Citar apenas manuais e ignorar artigos recentes sobre o tema.</li>
      <li>Não dialogar com posições contrárias à tese defendida.</li>
      <li>Descuidar da formatação e das normas da revista.</li>
      <li>Submeter sem revisão cuidadosa, com erros gramaticais evidentes.</li>
    </ul>
