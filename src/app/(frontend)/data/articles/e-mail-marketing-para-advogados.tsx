...
registerArticle('e-mail-marketing-para-advogados', () => (
  <>
    ...
    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Enviar newsletters com conteúdo informativo e educativo sobre temas jurídicos.</li>
      <li>Compartilhar artigos, análises de decisões judiciais e mudanças legislativas.</li>
      <li>Informar sobre eventos, webinars e palestras do escritório.</li>
      <li>Enviar comunicados institucionais, como mudanças de endereço ou novas áreas de atuação.</li>
      <li>Incluir informações de contato e link para o site do escritório.</li>
    </ul>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">O que é proibido</h3>

    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li>Enviar e-mails não solicitados com oferta direta de serviços (spam jurídico).</li>
      <li>Usar linguagem mercantilista, como "promoção", "desconto" ou "consulta grátis".</li>
      <li>Garantir resultados em processos ou usar casos de sucesso de forma sensacionalista.</li>
      <li>Comprar listas de e-mails para envio em massa.</li>
      <li>Fazer captação direta de clientela por e-mail.</li>
    </ul>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Tipos de e-mail que funcionam para escritórios</h2>

    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Newsletter periódica</h3>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">Sequência de boas-vindas</h3>
    ...
    <h3 className="text-xl font-bold text-[#162a2a] font-lexend mt-8 mb-3">E-mails de conteúdo aprofundado</h3>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Ferramentas para começar</h2>

    <p className="text-gray-700 leading-relaxed">
      Existem diversas plataformas de e-mail marketing com planos gratuitos que atendem escritórios de pequeno e médio porte. O <strong className="text-[#162a2a]">Mailchimp</strong> oferece plano gratuito para até 500 contatos. O <strong className="text-[#162a2a]">Brevo</strong> (antigo Sendinblue) permite até 300 envios por dia no plano free. O <strong className="text-[#162a2a]">MailerLite</strong> é outra opção com interface simples e plano gratuito para até 1.000 assinantes.
    </p>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Boas práticas para aumentar a taxa de abertura</h2>

    <ul className="list-disc pl-6 space-y-2 text-gray-700">
      <li><strong className="text-[#162a2a]">Assunto curto e direto:</strong> linhas de assunto com 6 a 10 palavras têm melhor desempenho. Evite clickbait. Seja claro sobre o que o leitor vai encontrar.</li>
      <li><strong className="text-[#162a2a]">Remetente com nome real:</strong> use "Dr. João Silva" ou "Escritório Silva Advocacia" em vez de "contato@escritorio.com". Pessoas abrem e-mails de pessoas.</li>
      <li><strong className="text-[#162a2a]">Frequência consistente:</strong> defina um dia e horário fixos para o envio. Terças e quintas entre 9h e 11h costumam ter boas taxas de abertura.</li>
      <li><strong className="text-[#162a2a]">Conteúdo escaneável:</strong> use subtítulos, parágrafos curtos e negritos nos pontos principais. Ninguém lê e-mails longos palavra por palavra.</li>
      <li><strong className="text-[#162a2a]">Link de descadastro visível:</strong> além de ser exigência legal (LGPD), facilitar o descadastro melhora a qualidade da lista e evita marcações como spam.</li>
    </ul>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Segmentação: enviando o conteúdo certo para a pessoa certa</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Métricas que importam</h2>

    <p className="text-gray-700 leading-relaxed">
      Acompanhe três números principais: <strong className="text-[#162a2a]">taxa de abertura</strong> (percentual de pessoas que abriram o e-mail), <strong className="text-[#162a2a]">taxa de cliques</strong> (percentual que clicou em algum link) e <strong className="text-[#162a2a]">taxa de descadastro</strong> (percentual que pediu para sair da lista). Uma taxa de abertura acima de 25% é considerada boa para o segmento jurídico. Se a taxa de descadastro passar de 1% por envio, revise a frequência ou o conteúdo.
    </p>

    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">LGPD e e-mail marketing jurídico</h2>
    ...
    <h2 className="text-2xl font-bold text-[#162a2a] font-lexend mt-10 mb-4">Começando com o mínimo viável</h2>
